...
- (void)viewDidLoad {
    ...
    NSString *strUrl = @"http://218.93.30.242:8777/m3u8/periodvideo/3777/25769803777/2297/4294967297/a/4294967297.m3u8";
//    @"http://he.yinyuetai.com/uploads/videos/common/080A01550943F9C13EED24FBF1933A39.flv?sc=aabb162ef563e9b2&br=3106&rd=iOS";
     ...
     //设置播放器标题
     playerView.videoTitle = @"测试";
     //设置播放器额外属性
     playerView.playedColor   = [UIColor orangeColor];
     playerView.cacheBarColor = [UIColor lightGrayColor];
